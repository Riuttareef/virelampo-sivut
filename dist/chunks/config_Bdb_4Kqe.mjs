...
function priceForLocation(loc) {
  return AREAS[loc.area].basePriceFrom;
}
const PERUSASENNUS_SISALTYY = [
...
export { AREAS as A, LOCATIONS as L, NAV as N, PERUSASENNUS_SISALTYY as P, REVIEWS as R, SITE as S, TRUST as T, LISATYOT as a, priceForLocation as p };
